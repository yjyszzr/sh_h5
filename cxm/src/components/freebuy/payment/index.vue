...
<template>
  <div class="wrap payment">
            ...
            <a>
              <div>
                <span
                  ...
                  @click="yhClick()"
                  v-show="payment.bonusList&&payment.bonusList.length>0"
                >
                  -￥{{payment.bonusAmount}}
    ...
    <button class="paymentBtn" @click="payBtn()" v-show="Number(payment.thirdPartyPaid)<=0||payCode!='app_offline'">确认支付</button>
  </div>
</template>
