            ...
            <section class="module-body">
                    ...
                    <div class="m2-c">
                        <div class="m2-progress" v-if="dq_pos.gear_position>0">
                            <div class="m2-kuai-box">
                                <div class="m2-kuai" :style="{left: `${activityUserInfo.invitation_number/dq_pos.gear_position>1?100:activityUserInfo.invitation_number/dq_pos.gear_position*100}%`}">
                                    <p>({{`${activityUserInfo.invitation_number}/${dq_pos.gear_position}`}})</p>
                                    <img src="../img/wz.png" alt="">
                                </div>
                            </div>
                            <el-progress :percentage="activityUserInfo.invitation_number/dq_pos.gear_position>1?100:(activityUserInfo.invitation_number/dq_pos.gear_position)*100" status="exception"></el-progress>
                        </div>
                        <img class="hb openBouns" @click="openBouns(dq_pos,'bl')" src="../img/hb.png" alt="" v-show="bounsStatus==1">
                        ...
                        <div class="m3-progress" v-if="acitvityRy.length>0">
                            ...
                            <div class="m3-jdt">
                                <div class="jdt-item" v-for="(item,i) of acitvityRy" :key='i'>
                                    ...
                                    <div class="jdt-item-c" :style="{color:Number(activityUserInfo.invitation_add_reward)>=Number(item.gear_position)?'#DF313F':'#979797'}">
                                    ...
                                    <div class="jdt-item-b">
                                        ...
                                        <img class="openBouns" @click="openBouns(item,'ry')" v-show="!item.show&&item.is_status=='0'&&Number(activityUserInfo.invitation_add_reward)>=Number(item.gear_position)" src="../img/dhb.png" alt="">
                ...
                <div class="m4" v-if="flShow>0">
                    ...
                    <div class="m4-c">
                        ...
                        <p>累计获得返利金额: <span>{{activityUserInfo.month_return_reward}} 元</span></p>
                    </div>
                </div>
                <!-- 模块5 -->
                <!-- <div class="m5">
            ...
            <div class="ct-box">
                <div class="ct" v-if="jtype=='bl'">
                    <div class="bl-m">
                        <h3>伯乐奖规则说明</h3>
                        <h4>* 活动介绍</h4>
                        在活动期间内，邀请好友注册下载圣和彩店APP，并且好友完成首次充值，您可获得现金奖励，邀请越多奖励越多，奖励金可购彩或提现；<br>
                        活动时间：<span>2019.07.01～2019.08.01</span><br>
                        <h4>* 奖励明细</h4>
                        1.固定奖励：每成功邀请一人可获得38元现金奖励<br>
                        2.额外奖励<br>
                        <table>
                            <tr>
                                <td>累计邀请人数(人)</td>
                        ...
                        例：假设邀请100人，可获得38x100+1888=5688元<br>
                        注：被邀请好友同时可以获得68元彩金券<br>
                        <h4>* 派奖说明</h4>
                        1.邀请单个好友，38元奖励金自动发放至您的总收益金账户，累计额外奖励需手动领取；<br>
                        2.邀请好友的奖励金可以转入到APP可提现账户，可继续进行购彩或提现；<br>
                        3.累计奖励金必须在活动时间内手动领取，过期未领则视为弃奖，系统予以清除，不予补发；<br>
                        4.当累计邀请人数达到100人时，往后邀请的好友只有固定邀请奖励，具体额外奖励上限人数以奖励明细）显示为准；<br>
                ...
                <div class="ct" v-if="jtype=='ry'">
                    <div class="ry-m">
                        <h3>荣耀奖规则说明</h3>
                        <h4>* 活动介绍</h4>
                        在活动期间内，您所有邀请的好友累计购彩金额<br>
                        总和达到不同档位时，可领对应奖励金，<br>
                        活动时间：<span>2019.07.01～2019.08.01</span><br>
                        <h4>* 奖励明细</h4>
                        <table>
                            <tr>
                        ...
                        例：假设活动期间内您受邀的好友总计购彩金额达到100000元，您总计可领取30+158+318+1600+3500=5606元<br>
                        <h4>* 派奖说明</h4>
                        1.好友累计购彩金额每达到对应奖励档位，您可领取对应现金奖励；<br>
                        2.好友购彩奖励金必须在活动时间内手动领取，过期未领则视为弃奖，系统予以清除，不予补发；<br>
                        3.每个用户在活动期内只享有一次参与权限，即好友累计购彩金额达到奖励上限时，超出金额不再给予奖励；<br>
                        <p>温馨提示：若有疑问，请联系官方客服咨询；</p>
                        <p>本活动最终解释权归圣和彩店所有</p>
                    </div>
                </div>
                <div class="ct" v-if="jtype=='fl'">
                    <div class="fl-m">
                        <h3>返利奖规则说明</h3>
                        <h4>* 活动介绍</h4>
                        在活动期间内，您所邀请的好友只要购彩一笔，您将获得好友购彩金额的<span>2%</span>返利，返利无限制，好友购彩次数越多，金额越高，您的返利奖励越多；<br>
                        活动时间：<span>2019.07.01～2019.08.01</span><br>
                        <h4>* 派奖说明</h4>
                        1.返利奖励是实时到账，您可在我的累计收益(账户明细)中查看收益详情；<br>
                        2.好友购彩奖励金必须在活动时间内手动领取，过期未领则视为弃奖，系统予以清除，不予补发；<br>
                        3.每个用户在活动期内只享有一次参与权限，即好友累计购彩金额达到奖励上限时，超出金额不再给予奖励；<br>
                        <p>温馨提示：若有疑问，请联系官方客服咨询；</p>
                        <p>本活动最终解释权归圣和彩店所有</p>
