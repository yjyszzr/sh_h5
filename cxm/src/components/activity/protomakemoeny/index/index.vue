      ...
      <section class="module-body">
        ...
        <div class="m6" v-show="acitvityBl.length>0||acitvityRy.length>0||flShow>0">
          ...
          <div class="m6-c">
            ...
            <p>*本活动最终解释权归{{$store.state.channelObj.channelNmae}}所有</p>
          </div>
        </div>
        <!-- 暂无活动展示 -->
    ...
    <div class="pro-mark" v-show="markShow">
      <div class="ct-box">
        <div class="ct" v-if="jtype=='bl'">
          <div class="bl-m">
            <h3>伯乐奖规则说明</h3>
            <h4>* 活动介绍</h4>在活动期间内，邀请好友注册下载{{$store.state.channelObj.channelNmae}}APP，
            <span>并且好友完成首充103元</span>，您可获得38现金奖励，被邀请好友同时可以获得68元购彩大礼包；
            <br />活动时间：
            <span>2019.11.17-2020.02.16</span>
            <br />
            ...
            <br />
            <p>温馨提示：请在活动期间完成以上邀请任务，若未能完成，则当期任务清零，</p>
            <p>下期奖励重新计算。如有疑问，请联系官方客服咨询；</p>
            <p>微信号：xiancaipaidian</p>
            <p>本活动最终解释权归{{$store.state.channelObj.channelNmae}}所有</p>
          </div>
        </div>
        <div class="ct" v-if="jtype=='ry'">
          <div class="ry-m">
            ...
            <br />
            <p>温馨提示：活动期间，若好友购彩未能达到一定消费档位，则当期任务清零，</p>
            <p>下期奖励重新计算。如有疑问，请联系官方客服咨询；</p>
            <p>微信号：xiancaipaidian</p>
            <p>本活动最终解释权归{{$store.state.channelObj.channelNmae}}所有</p>
          </div>
        ...
        <div class="ct" v-if="jtype=='fl'">
          <div class="fl-m">
            <h3>返利奖规则说明</h3>
            <h4>* 活动介绍</h4>在活动期间内，<span>邀请好友完成首充103元</span>，之后好友每次购彩，您可获得好友购彩金额的<span>2%</span>返利，返利无限制，好友购彩次数越多，您的返利奖励越多；
            <br />活动时间：
            <span>2019.11.17-2020.02.16</span>
            <br />
